...
class Transfer extends CI_Controller
{
        ...
        try {
            ...
            foreach ($data->cart as $cartProduct) {
                $transferDetails = array(
                    ...
                    'sell_rate'     => $cartProduct->sale_rate,
    ...
    public function getTransfers()
    {
        ...
        $transfers = $this->db->query("
                select
                    ...
                    (
                        ...
                        WHERE td.transfer_id = tm.transfer_id
                    ) as qty
        ...
        if (isset($data->search_type) && $data->search_type == 'with_details') {
            $transfers = array_map(function ($value) {
                $value->Details = $this->db->query("SELECT 
                        td.*,
                        p.Product_Code,
                        p.Product_Name,
                        p.model,
