...
class Supplier extends CI_Controller {
    ...
    public function getSupplierLedger(){
        ...
        $payments = $this->db->query("
            ...
            select
                'e' as sequence,
                dd.DamageDetails_SlNo as id,
                dm.Damage_Date as date,
                concat('Damage amount -', dm.Damage_InvoiceNo) as description,
                dd.damage_amount as bill,
                0.00 as paid,
                0.00 as due,
                0.00 as returned,
                0.00 as cash_received,
            ...
            where dd.supplier_id = '$data->supplierId'
            ...
            select
                ...
                drd.id,
                dr.date,
                concat('Damage return amount '- dr.invoice) as description,
                0.00 as bill,
                drd.amount as paid,
                0.00 as due,
                0.00 as returned,
            ...
            where drd.status = 'a'
            and dd.supplier_id = '$data->supplierId'
