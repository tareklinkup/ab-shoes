...
class Page extends CI_Controller
{
    ...
    {
        $sizes = $this->db->query("select * from tbl_size where status = 'a' order by id desc")->result();
    ...
    public function saveSize()
    {
        ...
        try {
            ...
            $dupSize = $this->db->query("select * from tbl_size where status = 'a' and name = ?", $data->name)->num_rows();

            if ($dupSize > 0) {
                $res->success = false;
                $res->message = "This $data->name already exists";
            }
    ...
    public function updateSize()
    {
        ...
        try {
            ...
            $dupSize = $this->db->query("select * from tbl_size where status = 'a' and name = ? and id != ?", [$data->name, $data->id])->num_rows();
            ...
            $this->db->where('id', $data->id)->update('tbl_size', $size);
    ...
    public function deleteSize()
    {
        ...
        try {
            ...
            $this->db->set('status', 'd')->where('id', $data->id)->update('tbl_size');
    ...
    public function membership()
    {
        ...
        $data['content'] = $this->load->view('Administrator/membership', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }

    public function getMemberships()
    {
        $memberships = $this->db->query("select * from tbl_membership where status = 'a' order by id desc")->result();
    ...
    public function saveMembership()
    {
        ...
        try {
            ...
            $this->db->insert('tbl_membership', $member);
    ...
    public function updateMembership()
    {
        ...
        try {
            ...
            $this->db->where('id', $data->id)->update('tbl_membership', $member);
    ...
    public function deleteMembership()
    {
        ...
        try {
            ...
            $this->db->set('status', 'd')->where('id', $data->id)->update('tbl_membership');
            $res->success = true;
    ...
    {
        $data = json_decode($this->input->raw_input_stream);
        $duplicate = $this->db->query("select model from tbl_product where status = 'a' and model= ?", trim($data->model))->num_rows();
    ...
    {
        $data = json_decode($this->input->raw_input_stream);
        $lastModel = $this->mt->generateProductModel();

        echo json_encode($lastModel);
    }
