			...
			<div class="col-md-5 col-md-offset-1">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-1" style="padding:0;margin-left: -15px;">
						<a href="" class="add-button"><i class="fa fa-plus"></i></a>
					</div>
				</div>
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Size:</label>
					<div class="col-md-7">
						<v-select v-bind:options="sizes" v-model="selectedSize" label="name"></v-select>
					</div>
					<div class="col-md-1" style="padding:0;margin-left: -15px;">
						<a href="" class="add-button"><i class="fa fa-plus"></i></a>
					</div>
			...
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					<div class="col-md-7 col-md-offset-4 text-right">
						<input type="submit" class="btn btn-success btn-sm" :disabled="this.product.Product_SlNo == '' ? true : false" value="Update">
					</div>
				</div>
				<!-- <div class="form-group clearfix">
	...
	new Vue({
		...
		methods: {
			...
			saveProduct() {
				...
				this.product.size = this.selectedSize.id;
				this.product.brand = this.selectedBrand.brand_SiNo;
