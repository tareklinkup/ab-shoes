...
<div id="profitLoss">
	...
	<div class="row" style="display:none;" :style="{display: show_report ? '' : 'none'}">
		<div class="col-md-12" style="margin: 10px 0;">
			...
			<a href="javascript:" onclick="exportToExcel('table1', 'Profit & loss - <?php echo date('D d F, Y') ?>')">
				<i class="fa fa-file-excel-o"></i> Profit & loss
			</a>
		</div>
		<div class="col-md-12">
			<div class="table-responsive" id="reportTable">
				<table id="table1">
					...
					<tfoot style="font-weight:bold;background-color:#e9dcdc;">
						...
						<tr>
							<td colspan="4" style="text-align:right;">Sale VAT (+)</td>
							<td colspan="2"></td>
			...
			otherIncome() {
				return (
					(
						...
						parseFloat(this.otherIncomeExpense.purchase_labour_cost) +
