		...
		<?php if (
			...
			<li class="">
				...
				<ul class="submenu">
					...
					<?php if (array_search("damageReturn", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>damageReturn">
								<i class="menu-icon fa fa-caret-right"></i>
								Damage Return
							</a>
							<b class="arrow"></b>
		...
		<?php if (
			...
			<li class="">
				...
				<?php endif; ?> -->
					...
					<?php if (array_search("membership", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>membership">
								<i class="menu-icon fa fa-caret-right"></i>
								<span class="menu-text"> Add Membership </span>
							</a>
							<b class="arrow"></b>
						</li>
					<?php endif; ?>
...
<?php } elseif ($module == 'AccountsModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("cash_drawer", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>cash_drawer">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text">Cash Drawer</span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("cashdrawer_record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>cashdrawer_record">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text">Cash Drawer Record</span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
