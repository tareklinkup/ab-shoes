		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<select class="form-control" v-if="memberships.length == 0"></select>
						<v-select v-bind:options="memberships" v-model="selectedMembership" label="name" v-if="memberships.length > 0"></v-select>
					</div>
					<div class="col-md-1" style="padding:0;margin-left: -15px;"><a href="/membership" target="_blank" class="add-button"><i class="fa fa-plus"></i></a></div>
				</div>
			
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Start Date:</label>
					<div class="col-md-7">
						<input type="date" class="form-control" v-model="customer.start_date">
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="date" class="form-control" v-model="customer.expire_date">
					</div>
				</div>
			</div>	
	...
	new Vue({
		...
		methods: {
			...
			saveCustomer(){
				...
				this.customer.membership_id = this.selectedMembership == null ? null : this.selectedMembership.id;
			...
			editCustomer(customer){
				...
				this.selectedMembership = this.memberships.find(item => item.id == customer.membership_id)
