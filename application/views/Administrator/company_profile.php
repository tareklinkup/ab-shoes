...
<div class="row">
	<div class="col-xs-12">
		...
		<form class="form-vertical" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>company_profile_Update">
			...
			<div class="form-group">
				<label class="control-label" for="form-field-1" style="margin-top:15px;"> Sale Note  </label>
				<div>
					<textarea id="note" name="note" class="form-control"><?php echo $selected->note; ?></textarea>
				</div>
			</div>
					...
					<div class="col-md-12">
						<form class="form-horizontal" @submit.prevent="saveBranch">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label no-padding-right">:</label>
								<div class="col-sm-8">
									<input type="text" placeholder="Bank Account" class="form-control" v-model="branch.account_name" required/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label no-padding-right">:</label>
								<div class="col-sm-8">
									<input type="text" placeholder="Account No" class="form-control" v-model="branch.account_no" required/>
								</div>
							</div>
    ...
    new Vue({
        ...
        methods: {
            ...
            editBranch(branch){
                ...
                this.branch.account_name = branch.account_name;
                this.branch.account_no = branch.account_no;
            },
