        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="accounts">
                    ...
                    <li><input type="checkbox" class="access" value="cash_drawer" v-model="access"> Cash Drawer</li>
                    <li><input type="checkbox" class="access" value="cashdrawer_record" v-model="access"> Cash Drawer Record</li>
