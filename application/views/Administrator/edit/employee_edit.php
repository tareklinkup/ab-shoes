...
<div class="row">
	<div class="form-horizontal">
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="em_nid" name="em_nid" value="<?php echo $selected->Employee_NID; ?>" placeholder="Employee NID .." class="form-control" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
			<input class="form-control" name="em_bankname" id="em_bankname" type="text" value="<?php echo $selected->bank_name; ?>" style="border-radius: 5px !important;" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
			<input class="form-control" name="em_account" id="em_account" type="text" placeholder="Bank account ..." style="border-radius: 5px !important;" value="<?php echo $selected->bank_account; ?>" />
			</div>
		</div>
