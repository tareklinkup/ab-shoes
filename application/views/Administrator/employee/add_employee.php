...
<div class="row">
	<div class="form-horizontal">
		...
		<hr/>
		<div class="form-group">
			<label class="col-sm-4 control-label" for="em_name"> NID </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="em_nid" name="em_nid" value="<?php echo set_value('em_nid'); ?>" placeholder="Employee NID .." class="form-control" />
				 <div id="em_nid_" class="col-sm-12"></div>
			</div>
		</div>
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="em_bankname">Bank Name</label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
			<input class="form-control" name="em_bankname" id="em_bankname" type="text" placeholder="Bank name ..." style="border-radius: 5px !important;" value="<?php echo set_value('em_bankname'); ?>" />
			</div>
		</div>

		<div class="form-group">
			<label class="col-sm-4 control-label" for="em_account">Account No.</label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
			<input class="form-control" name="em_account" id="em_account" type="text" placeholder="Bank account ..." style="border-radius: 5px !important;" value="<?php echo set_value('em_account'); ?>" />
			</div>
		</div>
...
<script type="text/javascript">
	function Employee_submit(){
		...
		var em_nid = $("#em_nid").val();
		if(em_nid==""){
			$("#em_nid").css('border-color','red');
			return false;
		}
		var em_bankname = $("#em_bankname").val();
		if(em_bankname==""){
			$("#em_bankname").css('border-color','red');
			return false;
		}
		var em_account = $("#em_account").val();
		if(em_account==""){
			$("#em_account").css('border-color','red');
			return false;
		}
		...
		fd.append('bank_name', $('#em_bankname').val());
		fd.append('account', $('#em_account').val());
		fd.append('nid', $('#em_nid').val());
