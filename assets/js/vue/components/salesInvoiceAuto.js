            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        ...
                        <strong>Date:</strong> {{ sales.SaleMaster_SaleDate }} {{ sales.AddTime | formatDateTime('h:mm a') }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <br>
                      <!--  <table class="pull-left" style="width:135px">
                            <tr>
                    ...
                    <div class="col-xs-6">
                        <table _t92sadbc2>
                            ...
                            <tr>
                                <td><strong>Exchange Total:</strong></td>
                                <td style="text-align:right">{{ sales.exchange_total }}</td>
                            </tr>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <p style="white-space: pre-line">{{ sales.exchange_note }}</p>
                    </div>
                </div>
            </div>
        </div>
